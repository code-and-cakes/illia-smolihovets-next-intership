...
export default function ProjectMenu(props: ProjectMenuProps) {
  ...
  return (
    <TaskPage>
      <div className="m-auto mt-16 flex w-8/12 flex-1 flex-col  text-white">
        ...
        >
          ...
          <button
            type="submit"
            className={cn(
              "w-fit rounded bg-linear-button-primary p-1 px-3 text-start"
            )}
          >
            Update
          </button>
        ...
        <div className="mt-6">
          ...
          <button
            className={cn(
              "mb-10 w-fit rounded bg-linear-button-secondary p-1 px-3 text-start"
            )}
          >
            Delete this Project
          </button>
